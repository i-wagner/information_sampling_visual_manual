function p = isSizeOdd(n)
%MATLAB Code Generation Private Function
%
%   Determines whether n is odd, assuming n is a non-negative integer
%   value.
%
%   This is a small utility function that is written to generate just the
%   code needed to determine whether a size value is odd. It does no error
