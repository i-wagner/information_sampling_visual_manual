...
%            0,                 epar.fixLoc_px(2) - ((min(epar.y) + ((max(epar.y) - min(epar.y)) / 2)) / epar.YPIX2DEG), ...
%            epar.SCREEN_X_PIX, epar.fixLoc_px(2) - ((min(epar.y) + ((max(epar.y) - min(epar.y)) / 2)) / epar.YPIX2DEG))
%     Screen('DrawLine', epar.window, epar.black, ...
%            epar.x_center, 0, ...
