...
%         gazeShifts_allTrials = [];
        for t = 1:data.ss.nCompletedTrials(s,c) % Trial
            if any(thisCondition == [1, 2]) % Visual search
                ...
                thisTrial.gazeShifts.isUniqueFix = ...
                    getUniqueFix(thisTrial.gazeShifts.fixatedAois(:,1));

                thisTrial.gazeShifts.duration = ...
                    thisTrial.gazeShifts.duration(thisTrial.gazeShifts.isUniqueFix);
                thisTrial.gazeShifts.idx = ...
                    thisTrial.gazeShifts.idx(thisTrial.gazeShifts.isUniqueFix);
                thisTrial.gazeShifts.latency = ...
                    thisTrial.gazeShifts.latency(thisTrial.gazeShifts.isUniqueFix);
                thisTrial.gazeShifts.meanGazePos = ...
                    thisTrial.gazeShifts.meanGazePos(thisTrial.gazeShifts.isUniqueFix);
                thisTrial.gazeShifts.offsets = ...
                    thisTrial.gazeShifts.offsets(thisTrial.gazeShifts.isUniqueFix);
                thisTrial.gazeShifts.onsets = ...
                    thisTrial.gazeShifts.onsets(thisTrial.gazeShifts.isUniqueFix);
