...
%% Analyse fixated areas of interest
data.ss.fixations = ...
    analyseFixations(exper, screen, anal, data.ss.gaze, ...
    ...
    for s = 1:exper.n.SUBJECTS % Subject
        ...
        for t = 1:thisSubject.nTrials % Trial
            ...
            thisTrial.gazeShifts.meanGazePos = ...
                data.ss.gaze.gazeShifts.meanGazePos{thisSubject.number,c}(thisTrial.idx,:);
            thisTrial.gazeShifts.idx = ...
                data.ss.gaze.gazeShifts.idx{thisSubject.number,c}(thisTrial.idx,:);
            thisTrial.gazeShifts.onsets = ...
                data.ss.gaze.gazeShifts.onsets{thisSubject.number,c}(thisTrial.idx,:);
            thisTrial.gazeShifts.offsets = ...
                data.ss.gaze.gazeShifts.offsets{thisSubject.number,c}(thisTrial.idx,:);
            thisTrial.gazeShifts.duration = ...
                data.ss.gaze.gazeShifts.duration{thisSubject.number,c}(thisTrial.idx);
            thisTrial.gazeShifts.latency = ...
                data.ss.gaze.gazeShifts.latency{thisSubject.number,c}(thisTrial.idx,:);
            thisTrial.timestamp.stimOn = ...
                data.ss.gaze.timestamps.stimOn{thisSubject.number,c}(t);
            thisTrial.timestamp.stimOff = ...
                data.ss.gaze.timestamps.stimOff{thisSubject.number,c}(t);
            thisTrial.events = ...
                data.ss.gaze.events{thisSubject.number,c}(t,:);
            thisTrial.gazeTrace = ...
                data.ss.gaze.trace{thisSubject.number,c}{t,:};
            thisTrial.gazeShifts.subset = ...
                logical(data.ss.fixations.subset{thisSubject.number,c}(thisTrial.idx));
            thisTrial.gazeShifts.informationLoss = ...
                data.ss.fixations.informationLoss{thisSubject.number,c}(thisTrial.idx);
            thisTrial.fixatedAois.groupIds = ...
                data.ss.fixations.fixatedAois.groupIds{thisSubject.number,c}(thisTrial.idx);
            thisTrial.fixatedAois.uniqueIds = ...
                data.ss.fixations.fixatedAois.uniqueIds{thisSubject.number,c}(thisTrial.idx);
            thisTrial.gazeShifts.wentToClosest = ...
                data.ss.fixations.wentToClosest{thisSubject.number,c}(thisTrial.idx);
            thisTrial.gazeShifts.distanceCurrent = ...
                data.ss.fixations.distanceCurrent{thisSubject.number,c}(thisTrial.idx);

            % Get inspection times
            thisTrial.time.leaving = ...
                getLeavingTimes(logical(thisTrial.gazeShifts.idx(thisTrial.gazeShifts.subset,3)), ...
                                thisTrial.gazeShifts.offsets(thisTrial.gazeShifts.subset,1), ...
                                thisTrial.gazeShifts.onsets(thisTrial.gazeShifts.subset,1), ...
                                thisTrial.timestamp.stimOff);
            [thisTrial.time.inspection, thisTrial.time.dwell] = ...
                getInspectionTime(thisTrial.fixatedAois.groupIds(thisTrial.gazeShifts.subset), ...
                                  [exper.stimulus.id.target.EASY, exper.stimulus.id.target.DIFFICULT], ...
                                  exper.stimulus.id.BACKGROUND, ...
                                  thisTrial.gazeShifts.offsets(thisTrial.gazeShifts.subset,1), ...
                                  thisTrial.gazeShifts.informationLoss(thisTrial.gazeShifts.subset), ...
                                  thisTrial.time.leaving, ...
            ...
            % Get response time
            thisTrial.time.response = ...
                getResponseTime(thisTrial.fixatedAois.uniqueIds(thisTrial.gazeShifts.subset), ...
                                thisTrial.gazeShifts.offsets(thisTrial.gazeShifts.subset,1), ...
                                thisTrial.timestamp.stimOff, ...
                                [exper.stimulus.id.target.EASY, exper.stimulus.id.target.DIFFICULT], ...
                                exper.stimulus.id.BACKGROUND);
            ...
            [thisTrial.chosenTarget.response, thisTrial.chosenTarget.fixation] = ...
                getChosenTarget([thisSubject.logFile(t,logCol.GAP_POSITION_EASY), ...
                                ...
                                thisTrial.fixatedAois.uniqueIds (thisTrial.gazeShifts.subset), ...
                                [exper.stimulus.id.target.EASY, exper.stimulus.id.target.DIFFICULT], ...
                                exper.stimulus.id.BACKGROUND);
