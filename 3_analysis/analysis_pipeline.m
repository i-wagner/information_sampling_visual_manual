...
for c = 1:exper.n.CONDITIONS % Condition
    for s = 1:exper.n.SUBJECTS % Subject
        ...
        for t = 1:thisSubject.nTrials % Trial
            ...
            thisTrial.gazeShifts.fixatedAois = ...
            ...
            [thisTrial.gazeShifts.subset, thisTrial.gazeShifts.qualityPassed] = ...
                selectFixationSubset(thisTrial.gazeShifts.fixatedAois(:,1), ...
            ...
            thisTrial.gazeShifts.informationLoss = ...
                getInformationLoss(thisTrial.gazeShifts.fixatedAois(thisTrial.gazeShifts.qualityPassed,1), ...
                                   thisTrial.gazeShifts.subset(thisTrial.gazeShifts.qualityPassed), ...
                                   logical(thisTrial.gazeShifts.idx(thisTrial.gazeShifts.qualityPassed,3)), ...
                                   thisTrial.gazeShifts.duration(thisTrial.gazeShifts.qualityPassed));
            ...
            [thisTrial.time.inspection, thisTrial.time.dwell] = ...
                getInspectionTime(thisTrial.gazeShifts.fixatedAois(thisTrial.gazeShifts.subset,2), ...
            ...
            thisTrial.time.response = ...
                getResponseTime(thisTrial.gazeShifts.fixatedAois(thisTrial.gazeShifts.subset,1), ...
                                thisTrial.gazeShifts.offsets(thisTrial.gazeShifts.subset,1), ...
                                thisTrial.timestamp.stimOff, ...
                                [exper.stimulus.id.target.EASY, exper.stimulus.id.target.DIFFICULT], ...
                                exper.stimulus.id.BACKGROUND);
            ...
            [~, ~, thisTrial.gazeShifts.distanceCurrent] = ...
                getDistanceToClosestStim(thisTrial.gazeShifts.fixatedAois(thisTrial.gazeShifts.subset,1), ...
                                         thisSubject.stimulusCoordinates(t,:,1), ...
                                         thisSubject.stimulusCoordinates(t,:,2), ...
                                         thisTrial.gazeShifts.meanGazePos(thisTrial.gazeShifts.subset,1), ...
                                         thisTrial.gazeShifts.meanGazePos(thisTrial.gazeShifts.subset,3), ...
                                         exper.stimulus.id.BACKGROUND, ...
                                         false);
