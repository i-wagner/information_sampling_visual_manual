function [li_gsToClosest, prop_gsClosest, prop_gsFurther, dist_out] = infSampling_distStim(gsOnset_x, gsOnset_y, targ_Aoi, stimLoc_x, stimLoc_y, flagBg)
    ...
    for gs = 1:no_gs % Gaze shift
        ...
        idx_closestStim = find(dists_trial == min(dists_trial));
...
%         if dist_out(gs, 4) == flagBg
% 
%             % If a gaze shift went to a location outside of any AOI (i.e.,
%             % the background), set it NaN
%             dist_out(gs, 5) = NaN;
% 
%         end
