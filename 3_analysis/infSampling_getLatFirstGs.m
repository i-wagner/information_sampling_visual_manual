function [lats_gsInSeq_dist, lats_gsInSeq_med, no_dp] = infSampling_getLatFirstGs(latencis, gsNos, gsOnSOI, trialNos, noOI)
    ...
    %% Get median latency
    lats_gsInSeq_med = [median(latencis(li_lat_gsOnSOI), 'omitnan') ...
