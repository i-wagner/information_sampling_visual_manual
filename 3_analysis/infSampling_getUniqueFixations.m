function no_unique_aoi_fixated = infSampling_getUniqueFixations(fixated_aoi, id_targ, id_bg)
    ...
    %% Get fixated stimuli
    % Using the "stable" argument, we are keeping the initial order of
    % individual fixations, which is important for subsequent analysis
    % steps
    unique_aoi_fixated = unique(fixated_aoi, 'stable');
