...
file_path <- "/Users/ilja/Dropbox/12_work/mr_informationSamplingVisualManual/responseTime_long.csv"
...
qqnorm(resid(fit2))
qqline(resid(fit2))
performance::check_model(fit2, dot_size=2, line_size=0.8, panel=TRUE, check="all")
anova(fit2)
