...
yLabels = repmat(["Proportion correct difficult", ...
                 ...
                 1, 2);
axLimits = [[0.50, 1]; [100, 1700]; [100, 1700]; [100, 1700]; ...
            [0.50, 1]; [100, 1700]; [100, 1700]; [100, 1700]];
axTicks = [{axLimits(1,1):0.25:axLimits(1,2)}, ...
           {axLimits(2,1):500:axLimits(2,2)}, ...
           {axLimits(3,1):500:axLimits(3,2)}, ...
           {axLimits(4,1):500:axLimits(4,2)}, ...
           {axLimits(5,1):0.25:axLimits(5,2)}, ...
           {axLimits(6,1):500:axLimits(6,2)}, ...
           {axLimits(7,1):500:axLimits(7,2)}, ...
           {axLimits(8,1):500:axLimits(8,2)}];
...
for p = 1:nPanels % Panel
    ...
    doesCutoff = checkAxLim([axLimits(p,:), axLimits(p,:)], plotDat(:,:,p));
    if doesCutoff
